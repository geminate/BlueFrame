<!--[if IE 9]>
	<script src="${ctxStatic}/metronic/global/plugins/respond.min.js"></script>
	<script src="${ctxStatic}/metronic/global/plugins/excanvas.min.js"></script> 
<![endif]-->
<!-- BEGIN CORE PLUGINS -->
<script src="${ctxStatic}/metronic/global/plugins/jquery.min.js" type="text/javascript"></script>
<!--[if IE 9]>	
	<script src="${ctxStatic}/plugins/jquery-placeholder/jquery-placeholder.min.js"></script> 
<![endif]-->
<script src="${ctxStatic}/metronic/global/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/metronic/global/plugins/js.cookie.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/metronic/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
...
<script src="${ctxStatic}/metronic/layouts/layout/scripts/layout.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/metronic/layouts/layout/scripts/demo.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/metronic/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
