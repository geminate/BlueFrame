...
<!-- 标题 -->
<sitemesh:title>附件管理 - 添加页</sitemesh:title>
...
<sitemesh:container>
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li>
				<a href="${ctx}/frame/sys/sysFile/insert">添加页</a>
			</li>
		</ul>
	</div>
	<!-- 标题 -->
	<h3 class="page-title">
		附件管理<small>&emsp;添加页&emsp;</small>
	</h3>
	<div class="row">
		<div class="col-md-12">
			<div class="portlet box green">
				...
				<div class="portlet-body form">
					<form action="${ctx}/frame/sys/sysFile/insert" class="horizontal-form" method="post" data-validate>
						<div class="form-body">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-icon right">
											<i class="fa"></i>
											<input name="fileType" type="text" class="form-control" placeholder="请输入文件类型">
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-icon right">
											<i class="fa"></i>
											<input name="foreignId" type="text" class="form-control" placeholder="请输入外键ID">
										</div>
									</div>
								</div>
							</div>
							<div class="row">			
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-icon right">
											<i class="fa"></i>
											<input name="filePath" type="text" class="form-control" placeholder="请输入文件地址">
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="input-icon right">
											<i class="fa"></i>
											<input name="fileName" type="text" class="form-control" placeholder="请输入文件名">
										</div>
									</div>
								</div>
							</div>							
