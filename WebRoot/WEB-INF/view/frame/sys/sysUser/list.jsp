...
<body>
	<jsp:include page="/WEB-INF/view/include/topNav.jsp">
		<jsp:param name="topNavActive" value="sys" />
	</jsp:include>
			...
			<div class="col-xs-12">
				...
				<form class="form-inline search-form" id="search-form" style="overflow: auto;">
					...
					<div class="col-sm-4 search-form-btnDiv">
						...
						<a class="btn btn-primary" href="${ctx}/frame/sys/sysUser/insert">新增</a>
					</div>
				</form>
				<hr>
						...
						},
						{
							"render" : function(data, type, row, meta) {
								...
								var deleteA = "<a href='javascript:' onclick='GLOBAL.DATATABLE.deleteRow(this)'"
										+ " data-datatable-url='${ctx}/frame/sys/sysUser/delete'" + " data-datatable-param='" + row.id + "'"
